"""
IMPROVED Volatility Data Fetcher
Collect implied and realized volatility data with proper labeling
"""
...
class VolatilityDataFetcher:
    ...
    def get_spx_volatility_surface_labeled(self):
        ...
        try:
            print("📊 Fetching SPX volatility surface with proper labels...")
            ...
            if surface_data:
                ...
                print(f"✅ Retrieved SPX volatility surface: {valid_fields} fields with data")
                return surface_data
            else:
                return None
    ...
    def save_volatility_data_labeled(self, vol_df, spx_surface, tickers_processed):
        ...
        try:
            ...
            print(f"✅ Labeled volatility data saved to: {vol_file}")
            ...
            if spx_surface:
                ...
                print(f"✅ SPX labeled volatility surface saved to: {surface_file}")
            ...
            print(f"❌ Failed to save labeled volatility data: {e}")
...
def main():
    ...
    try:
        ...
        if vol_df is not None and not vol_df.empty:
            print(f"\n✅ Labeled volatility data summary:")
            ...
            print("\n📊 Sample LABELED volatility data:")
        ...
        if spx_surface:
            print("✅ SPX labeled volatility surface retrieved:")
        ...
        if vol_df is not None and not vol_df.empty:
            ...
            if vol_file:
                print(f"\n✅ LABELED volatility data collection completed successfully!")
                print(f"Files saved in: data/processed/volatility/")
                print(f"\n🎯 Key improvements:")
                print(f"   ✅ Proper realized vs implied volatility labeling")
                print(f"   ✅ Clear time period indicators (30d, 90d, etc.)")
                print(f"   ✅ Moneyness labels for implied vol")
                print(f"   ✅ Comprehensive field descriptions")
                return True
        else:
